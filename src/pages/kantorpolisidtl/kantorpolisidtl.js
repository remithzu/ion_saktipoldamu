 ...
 */
var KantorpolisidtlPage = /** @class */ (function () {
    function KantorpolisidtlPage(navCtrl, http, storage, loadingCtrl, navParams, alert, toasCtrl) {
        var _this = this;
    ...
    KantorpolisidtlPage = __decorate([
        IonicPage(),
        Component({
    ...
    return KantorpolisidtlPage;
}());
export { KantorpolisidtlPage };
//# sourceMappingURL=kantorpolisidtl.js.map